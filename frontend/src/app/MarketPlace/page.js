    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-emerald-950 to-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 pt-20 pb-12 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-emerald-600/20 to-green-600/20 backdrop-blur-xl px-6 py-3 rounded-full border border-emerald-500/30 mb-8 shadow-lg shadow-emerald-500/20">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <button
              ...
              className="group relative inline-flex items-center space-x-3 px-10 py-5 bg-gradient-to-r from-emerald-600 via-green-600 to-lime-600 hover:from-emerald-500 hover:via-green-500 hover:to-lime-500 disabled:from-gray-700 disabled:to-gray-700 text-white rounded-2xl font-bold text-lg shadow-2xl shadow-emerald-500/40 hover:shadow-emerald-500/60 transition-all duration-300 hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed overflow-hidden"
            >
          ...
          {loadingPrices && (
            <div className="flex flex-col items-center space-y-6 py-20">
              <div className="relative">
                ...
                <div
                  className="absolute inset-0 w-20 h-20 border-4 border-green-500/20 border-t-green-500 rounded-full animate-spin delay-150"
                  style={{ animationDirection: "reverse" }}
                ></div>
              </div>
              <div className="text-center">
                <p className="text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-400 mb-2">
          ...
          {marketPrices && !loadingPrices && (
            <div className="space-y-8 animate-fade-in">
              {/* Market Info Card */}
              <div className="bg-gradient-to-br from-gray-900/80 via-emerald-950/50 to-black/50 backdrop-blur-xl border border-emerald-500/20 rounded-3xl p-8 shadow-2xl">
                  ...
                  >
                    ...
                    <div
                      className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ${
                        item.trend === "up"
                          ...
                          : "bg-gradient-to-br from-green-600/10 to-lime-600/10"
                      }`}
                    ></div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-start space-x-2 bg-lime-600/10 border border-lime-500/20 rounded-lg p-3">
                          <AlertCircle className="w-4 h-4 text-lime-400 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-gradient-to-br from-gray-900/80 via-emerald-950/50 to-black/50 backdrop-blur-xl border border-emerald-500/20 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50">
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-lime-600/20 rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          {!marketPrices && !loadingPrices && (
            <div className="text-center py-20">
              <div className="w-24 h-24 bg-gradient-to-br from-emerald-600/20 to-green-600/20 rounded-3xl flex items-center justify-center mx-auto mb-6 border border-emerald-500/30">
